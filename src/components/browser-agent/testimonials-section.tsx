...
const testimonials: Testimonial[] = [
	...
	},
	{
		...
		company: "Loop Labs",
		quote:
			"Escalations went from thirty browser tabs to one Slack summary. Clickbuy reads Zendesk, digs into admin consoles, and loops us in only when policy demands it.",
			...
			<div className="mx-auto max-w-5xl rounded-3xl border border-white/10 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-900/80 p-10">
				<div className="mb-12 text-center">
					...
					<h2 className="mt-4 text-3xl font-bold text-white md:text-4xl">
						Teams trust Clickbuy Browser Agent to run real work
					</h2>
				</div>
