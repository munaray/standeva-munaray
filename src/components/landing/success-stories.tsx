...
const caseStudies = [
	...
	},
	{
		...
		rating: 5,
		testimonial:
			"We needed sentiment analysis for customer feedback but building an ML pipeline would have taken months. ProcessZero's AI/ML APIs got us production-ready features in days. The documentation and support made integration seamless.",
		apiUsed: "AI/ML APIs",
		results: [
			"Live in 3 days",
			"1M+ API calls/month",
	...
	},
	{
		...
		rating: 5,
		testimonial:
			"Our app needed custom backend APIs with real-time sync. ProcessZero built exactly what we needed in 6 weeks. The APIs are fast, reliable, and the custom solution fits our unique requirements perfectly.",
			...
			<div className="container mx-auto px-6">
				<div className="text-center mb-16">
					...
					<p className="text-lg text-[#CBD5E1] max-w-3xl mx-auto leading-relaxed">
						...
						effortlessly with ProcessZero&apos;s APIs.
					</p>
				</div>
