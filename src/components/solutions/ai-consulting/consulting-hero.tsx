				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					<motion.div
						...
						<motion.p 
							...
							Our expert consultants help you navigate AI&apos;s complexities and harness its potential to solve critical business challenges—from operational inefficiencies to customer experience transformation.
						</motion.p>
						...
						<motion.div 
							...
							<motion.button
								className="px-8 py-4 border-2 border-slate-700 text-white font-semibold rounded-lg hover:border-blue-500 hover:bg-blue-500/10 transition-all inline-flex items-center justify-center gap-3"
								whileHover={{ scale: 1.05 }}
								whileTap={{ scale: 0.95 }}>
							...
							{stats.map((stat, index) => (
								<motion.div
									...
									<div className={`text-2xl md:text-3xl font-bold ${stat.color} mb-1`}>
										...
										{stat.label.includes("Response") && "hr"}
									</div>
						...
						<motion.div 
							...
							{[
								{ icon: CheckCircle2, text: "Proven ROI Results" },
								{ icon: CheckCircle2, text: "End-to-End Support" },
								{ icon: CheckCircle2, text: "Secure & Compliant" }
							].map((item, index) => (
								<motion.div
									key={index}
